...
export const en = {
  ...
  'act.new.title': 'New activity',
  'act.edit.title': 'Edit activity',
  'act.field.date': 'Date',
  'act.field.title': 'What happened',
  'act.field.notes': 'Notes',
  'act.titlePlaceholder': 'e.g. Week 3 — dinner at Emily’s',
  'act.notesPlaceholder': 'How it went, who turned up, anything to remember.',
  'act.err.date': 'Pick a date for this activity.',
  'act.empty': 'Nothing recorded for this group yet.',
  'act.photos': 'Photos',
  'act.addPhoto': '＋ Add photo',
  'act.photoCount': '{n} photo(s)',
  'act.uploading': 'Uploading…',
  'act.removePhoto': 'Remove photo',
  'act.removePhoto.title': 'Remove this photo?',
  'act.removePhoto.message': 'It disappears from this record. This cannot be undone.',
  'act.delete.title': 'Delete this activity?',
  'act.delete.message': 'The record of {date}, and every photo on it, is deleted. This cannot be undone.',
  'act.toast.created': 'Activity recorded',
  'act.toast.saved': 'Activity saved',
