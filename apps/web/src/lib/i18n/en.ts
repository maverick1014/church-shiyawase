...
export const en = {
  ...
  'group.weeklySub': 'By year / month · the month’s Sundays, then this group’s own meetings · tick means present',
  'group.sheet.sundays': 'Sunday services',
  'group.sheet.own': 'This group’s meetings',
  'group.sheet.shared': 'The Sunday ticks are the church’s own record: the same rows the Services roll call shows, whichever page they are ticked on.',
  'group.week': 'Week {n}',
