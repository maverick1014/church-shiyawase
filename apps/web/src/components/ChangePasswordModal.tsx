...
import { ErrorBanner, Field, Modal, PasswordInput, useFormGuard, useToast } from './ui';
...
export function ChangePasswordModal({
  ...
  // Typed-but-unsubmitted passwords are worth one question before they go.
  const { close } = useFormGuard({ current, next, confirmPw }, onClose);
  ...
  return (
    <Modal title={t('password.title')} onClose={close}>
